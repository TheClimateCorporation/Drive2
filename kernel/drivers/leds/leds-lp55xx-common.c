...
int lp55xx_init_device(struct lp55xx_chip *chip)
{
	...
	if (pdata->enable_gpiod) {
		...
		gpiod_direction_output(pdata->enable_gpiod, 1);
						      ...
						      struct lp55xx_chip *chip)
{
	...
	/* Check for GPIO first since that may not be avilable yet */
