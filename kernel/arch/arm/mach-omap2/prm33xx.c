...
{
	/* Configure RSTTIME1 to max value to lengthen the time
	 * that nRESETIN_OUT is held low durring warm reset
	 */
	u32 regval = am33xx_prm_read_reg(AM33XX_PRM_DEVICE_MOD,
					 AM33XX_PRM_RSTTIME_OFFSET);
	regval |= 0xff;
	am33xx_prm_write_reg(regval, AM33XX_PRM_DEVICE_MOD,
			     AM33XX_PRM_RSTTIME_OFFSET);
