...
#define PRM_RSTST_GLOBAL_COLD_RST	BIT(0)
#define PRM_RSTST_GLOBAL_WARM_SW_RST	BIT(1)
#define PRM_RSTST_WDT1_RST		BIT(4)
#define PRM_RSTST_EXTERNAL_WARM_RST	BIT(5)
#define PRM_RSTST_ICEPICK_RST		BIT(9)
