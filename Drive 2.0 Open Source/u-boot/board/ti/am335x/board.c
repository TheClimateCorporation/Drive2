...
const struct dpll_params *get_dpll_ddr_params(void)
{
	...
	else if (board_is_pb() || board_is_bone_lt() || board_is_icev2() || board_is_edith())
...
const struct dpll_params *get_dpll_mpu_params(void)
{
	...
	if (board_is_pb() || board_is_bone_lt() || board_is_edith())
		freq = MPUPLL_M_1000;
...
static void scale_vcores_bone(int freq)
{
	 ...
	 * a Beaglebone Black / Edith it supports 1GHz.
	 */
	if (board_is_pb() || board_is_bone_lt() || board_is_edith() )
		freq = MPUPLL_M_1000;
	 ...
	 * Set LDO3 to 1.8V and LDO4 to 3.3V for Beaglebone Black / Edith.
	 */
	if (board_is_bone()) {
...
void scale_vcores(void)
{
	...
	if (board_is_beaglebonex() || board_is_edith())
...
void sdram_init(void)
{
	...
	else if (board_is_pb() || board_is_bone_lt() || board_is_edith())
