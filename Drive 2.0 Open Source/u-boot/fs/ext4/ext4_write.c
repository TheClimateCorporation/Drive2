...
/* Continue writing to ext4 filesystem with metadata checksum feature even
 * though Linux will consider the filesystem corrupt.
 */
#define EXT4_CORRUPT_WRITE_ON_META_CSUM
...
#ifdef EXT4_CORRUPT_WRITE_ON_META_CSUM
		printf("Feature metadata_csum found: Write will corrupt filesystem!\n");
#else
