...
# DTO sets changes localstatedir from /var to /data/system/var so that
# state information is preserved across reboots
BLUEZ5_UTILS_CONF_OPTS = \
	--enable-tools \
	--enable-library \
	--disable-cups \
	--with-dbusconfdir=/etc \
	--localstatedir=/data/system/var
...
ifeq ($(BR2_PACKAGE_BLUEZ5_UTILS_CLIENT),y)
define BLUEZ5_UTILS_COPY_ADDITIONAL_BINS
    echo POST_INSTALL_TARGET
    cp $(@D)/tools/btmgmt $(TARGET_DIR)/usr/bin
endef
BLUEZ5_UTILS_POST_INSTALL_TARGET_HOOKS += BLUEZ5_UTILS_COPY_ADDITIONAL_BINS
endif
